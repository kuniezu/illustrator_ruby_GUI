...
(function () {
    ...
    function makeHSpec() { var renderSpec = FormalAreaTextRenderSpec.create({ sourceFrameId: "diagnostic-source", annotationId: "diagnostic-annotation", logicalSegmentId: "h1", reading: "かな", appearance: { fontName: "fallback", fontSize: 8, manualDeltaX: 0, widthScale: 1, gapEm: .15 }, geometry: { autoLeft: 10, autoTop: 20, autoWidth: 40, boxHeight: 12 }, meta: { requestId: "diag-h", generationId: "g1", physicalId: "hp1" }, composerPolicy: { trackingCandidates: [0, -25, -50, -75, -100] } }); if (!FormalAreaTextRenderSpec.validate(renderSpec).ok) throw Error("h-render-spec-invalid"); return FormalAreaTextRenderSpec.backendSpec(renderSpec); }
