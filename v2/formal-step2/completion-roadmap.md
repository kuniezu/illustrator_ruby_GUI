...
- Keep a standalone, dependency-free compatibility lint command for production source; ESLint/TypeScript remain optional future adapters and are not required runtime dependencies.
