...
var FormalMulti = (function () {
    ...
    function copyOccurrence(o) { return {occurrenceId:o.occurrenceId,start:o.start,end:o.end,surface:o.surface,groupId:o.groupId,visible:o.visible,enabled:o.enabled,reading:o.reading,readingConfirmed:o.readingConfirmed,lineage:o.lineage.slice(0),unsupported:!!o.unsupported,renderStatus:o.renderStatus||"pending",renderReasons:(o.renderReasons||[]).slice(0),renderBoundaries:(o.renderBoundaries||[]).slice(0),renderUnresolvedBoundaries:(o.renderUnresolvedBoundaries||[]).slice(0)}; }
